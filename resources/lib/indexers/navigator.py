...
class navigator:
    ...
    def getCategories(self):
        ...
        for category in categories:
            ...
            if category_title is not None and category_count is not None:
    ...
    def getItems(self, url):
        ...
        try:
            ...
            xbmc.log(f'Mozikatalogus | getOnlyMovies | next_page_url | csak egy oldal található', xbmc.LOGINFO)
    ...
    def extractMovie(self, url, img_url, hun_title, content):
        ...
        if iframe_tag:
            ...
            xbmc.log(f'Mozikatalogus | extractMovie | iframe_src | {iframe_src}', xbmc.LOGINFO)
    ...
    def getOnlySeries(self):
        ...
        try:
            ...
            xbmc.log(f'Mozikatalogus | getOnlySeries | next_page_url | csak egy oldal található', xbmc.LOGINFO)
    ...
    def extractEpisodes(self, url, img_url, hun_title, content, ep_title):
        ...
        if iframe:
            ...
            xbmc.log(f'Mozikatalogus | extractEpisodes | iframe_src | {iframe_src}', xbmc.LOGINFO)
    ...
    def playMovie(self, url, subtitle_link):
        ...
        if re.match(r'.*on[vid,mov].*', url):
            ...
            xbmc.log(f'Mozikatalogus | playMovie | playing onvid: {url}', xbmc.LOGINFO)
            ...
            try:
                ...
                xbmc.log(f'Mozikatalogus | playMovie | direct_url: {direct_url}', xbmc.LOGINFO)
                play_item = xbmcgui.ListItem(path=direct_url)
                xbmcplugin.setResolvedUrl(syshandle, True, listitem=play_item)
            except:
                xbmc.log(f'Mozikatalogus | playMovie | name: No video sources found', xbmc.LOGINFO)
